...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="css/daftar_karyawan.css">
    ...
    <div class="card font3 warna2" id="tb_daftar_karyawan">
        ...
        <div class="card-body warna2">
            ...
            <div class="card-body color3 isi">
                    <p class="card-text">Sudah punya akun? klik disini untuk <a href="karyawan.php">login</a></p>
