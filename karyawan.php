...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="css/karyawan.css">
...
<div class="container-fluid warna2">
   <div class="row"> 
        ...
        <div class="col pembuka text-center ">
            <b> Sukses tidak diukur menggunakan kekayaan, sukses adalah sebuah pencapaian yang kita inginkan. Selamat bekerja.</b>
    ...
    <div class="card font3 warna2" id="login">
        <div class="card-header text-center font4">
            <p> Silakan Login Terlebih Dahulu </p>
    </div>
        <p>
        <div class="card-body warna2">
            <div class="login font3 text-center">
                <form action="simpan_login_karyawan.php" method="POST" >
            ...
            <div class="card-body color3 isi">
                    <p class="card-text">Belum punya akun? klik disini untuk <a href="daftar_karyawan.php">daftar</a></p>
                    <a href="index.php"> <button class="button btn btn-primary text">Home</button></a> 
                    <a href="pelanggan.php"> <button class="button btn btn-primary text">Pelanggan</button> </a>
                </div>
        </div>
    </div>
